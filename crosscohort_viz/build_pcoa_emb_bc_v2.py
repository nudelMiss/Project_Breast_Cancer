...
centering (batch correction). Writes pcoa_embedding_batchcorrected.png (new file)."""
import re
...
meta.to_csv(OUT/"pcoa_embedding_bc_coords.csv",index=False)
...
ax.set_title("PCoA \u2014 batch-corrected propr embeddings (per-patient, strong cell types, 4 cohorts)")
seen={}
...
fig.savefig(OUT/"pcoa_embedding_batchcorrected.png",dpi=160,bbox_inches='tight',bbox_extra_artists=(leg1,leg2))
plt.close(fig); print("[FIG] pcoa_embedding_batchcorrected.png",flush=True); print("DONE",flush=True)
