...
plt.close(fig)
print("[FIG] crosscohort_viz/umap/umap_emb_6cohort_v2_ellipse.png",flush=True); print("DONE",flush=True)
...
print("[FIG] crosscohort_viz/umap/umap_emb_6cohort_v2_noellipse.png",flush=True)
