...
meta.to_csv(OUT/"umap_emb_6cohort_coords.csv",index=False)
...
fig.savefig(OUT/"umap_emb_6cohort_ellipse.png",dpi=160,bbox_inches='tight',bbox_extra_artists=(leg1,leg2))
plt.close(fig)
print("[FIG] crosscohort_viz/umap/umap_emb_6cohort_ellipse.png",flush=True); print("DONE",flush=True)
...
fig2.savefig(OUT/"umap_emb_6cohort_noellipse.png",dpi=160,bbox_inches='tight',bbox_extra_artists=(lg1,lg2)); plt.close(fig2)
print("[FIG] crosscohort_viz/umap/umap_emb_6cohort_noellipse.png",flush=True)
