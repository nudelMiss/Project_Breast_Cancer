...
Writes pcoa_pseudobulk_batchcorrected.png (new file)."""
import re
...
meta.to_csv(OUT/"pcoa_pseudobulk_bc_coords.csv",index=False)
...
ax.set_title("PCoA \u2014 batch-corrected pseudobulk (sample \u00d7 cell type), 7 cohorts")
seen={}
...
fig.savefig(OUT/"pcoa_pseudobulk_batchcorrected.png",dpi=160,bbox_inches='tight',bbox_extra_artists=(leg1,leg2))
plt.close(fig); print("[FIG] pcoa_pseudobulk_batchcorrected.png",flush=True); print("DONE",flush=True)
